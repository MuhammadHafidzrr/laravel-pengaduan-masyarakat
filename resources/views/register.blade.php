...
<body>
    ...
    <section class="text-center text-lg-start">
        ...
        <nav class="navbar fixed-top" style="background-color: #ADD8E6; backdrop-filter: blur(10px);">
            <div class="container">
                <a class="navbar-brand text-black fs-4" href="#">
                    <img src="https://o.remove.bg/downloads/2a9a69c1-75cc-4005-8ad5-1631a6c23078/images-removebg-preview.png" width="50px" heigth="50px"> Pengaduan Masyarakat</a>
        ...
        <div class="container py-4">
            ...
            ">
                ...
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <img id="gambar1" src="https://1.bp.blogspot.com/-V__EfOy8-7s/YGhrHuyCkrI/AAAAAAAAR1g/XahDOdxKePk-oRG1BcomaWKo-huxRTO-gCLcBGAsYHQ/s1920/anime-phone-wallpaper-53.jpg" class=" rounded-4 shadow-4" alt="" />
                </div>
            </div>
        </div>
        <!-- Jumbotron -->
