...
<body>
    <section class="text-center text-lg-start">
        ...
        <nav class="navbar" style="background-color: #000000; backdrop-filter: blur(10px);">
            <div class="container-fluid">
                <a class="navbar-brand text-light fs-4" href="#">
                    <img src="https://o.remove.bg/downloads/6503c01a-1db0-44ea-90fe-0333ef6d0215/images-removebg-preview.png" width="50px" heigth="50px"> Pengaduan Masyarakat</a>
        ...
        <div id="bungkusPertama">
            ...
            <div id="bungkusGambar">
                <img src="https://w0.peakpx.com/wallpaper/334/580/HD-wallpaper-sukuna-curse-demon-jujutsu-jujutsu-kaisen-thumbnail.jpg">
            </div>
